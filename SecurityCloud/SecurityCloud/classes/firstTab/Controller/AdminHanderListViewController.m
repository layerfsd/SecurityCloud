//
//  AdminHanderListViewController.m
//  SecurityCloud
//
...
@interface AdminHanderListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation AdminHanderListViewController
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadData:) name:AdminHanderListViewControllerReload object:nil];
}
