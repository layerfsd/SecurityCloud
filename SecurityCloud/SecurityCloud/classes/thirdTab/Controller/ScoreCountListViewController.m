//
//  ScoreCountListViewController.m
//  SecurityCloud
//
...
@interface ScoreCountListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ScoreCountListViewController
...
-(void)loadData {
    ...
    [HttpTool post:@"/api/adminjifenmingxi.html" parameters:parameters success:^(id responseObject) {
        if (_page == 0) {
